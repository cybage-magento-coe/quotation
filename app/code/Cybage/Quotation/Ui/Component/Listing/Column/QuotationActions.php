...
namespace Cybage\Quotation\Ui\Component\Listing\Column;
...
class QuotationActions extends Column {
    ...
    const QUOTATION_URL_PATH_DELETE = 'blog/post/delete';
...
//                    $item[$name]['delete'] = [
//                        'href' => $this->urlBuilder->getUrl(self::QUOTATION_URL_PATH_DELETE, ['id' => $item['id']]),
//                        'label' => __('Delete'),
//                        'confirm' => [
